...
Renderer::Renderer(Window &parent) : OGLRenderer(parent) {
	...
	camera->SetPosition(Vector3(heightMap->RAW_WIDTH*heightMap->HEIGHTMAP_X/2.0f,500.0f, heightMap->RAW_WIDTH*heightMap->HEIGHTMAP_X));

	light = new Light(Vector3((heightMap->RAW_HEIGHT*heightMap->HEIGHTMAP_X / 2.0f), 500.0f, (heightMap->RAW_HEIGHT*heightMap->HEIGHTMAP_Z / 2.0f)), Vector4(0.9f, 0.9f, 1.0f, 1), (heightMap->RAW_WIDTH*heightMap->HEIGHTMAP_X) / 2.0f);
...
void Renderer::DrawWater() {
	...
	float heightX = (heightMap->RAW_WIDTH*heightMap->HEIGHTMAP_X / 2.0f);
	float heightY = 256* heightMap->HEIGHTMAP_Y / 3.0f;
	float heightZ = (heightMap->RAW_WIDTH*heightMap->HEIGHTMAP_Z / 2.0f);
